...
U běžných klapek VarioBreeze se `zone`, `type` a `damper_index` odvozují ze `slave_id`. Když je do `damper-map.json` uvedete ručně, bridge zkontroluje, že odpovídají odvozené hodnotě.
